# acp-clj
ACP (agent client protocol) implementation in Clojure

The goal of the library is to implement agent client protocol in Clojure using only dependencies of babashka
